[![codecov](https://codecov.io/gh/paulmwatson/msc/branch/master/graph/badge.svg)](https://codecov.io/gh/paulmwatson/msc/)
[![Build Status](https://travis-ci.org/paulmwatson/msc.png)](https://travis-ci.org/paulmwatson/msc)
...
Apps go in the project directory `msc`
...
| `TAG_MANAGER_CONTAINER_ID` | undefined | String | [Google Tag Manager](tagmanager.google.com) Container ID. [Use this to set up Google Analytics.](https://support.google.com/tagmanager/answer/6107124?hl=en). Required unless `TAG_MANAGER_ENABLED` is set to `True` |
